...
Radius 0.75rem, cards rounded-2xl, soft blue-tinted shadows (--shadow-card/glow/elevated), --gradient-surface for card backgrounds.
Admin scope keeps its own dark tokens.
