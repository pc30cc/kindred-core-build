-- 167_admin_export_function_ddl.sql
-- admin_export_schema_ddl() deliberately skips its own definition (it would be
-- rewritten mid-dump), which left the self-host target without that function.
-- This helper lets the Express migration service fetch any single public
-- function's CREATE statement and append it at the end of the schema replay.
