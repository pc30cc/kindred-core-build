...
DROP TRIGGER IF EXISTS seo_urls_scope_guard ON public.seo_urls;
...
DROP TRIGGER IF EXISTS seo_observations_scope_guard ON public.seo_crawl_observations;
...
DROP TRIGGER IF EXISTS seo_membership_scope_guard ON public.seo_crawl_url_membership;
