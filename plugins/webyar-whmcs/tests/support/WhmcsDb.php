...
final class WhmcsDb
{
    ...
    private static function seedRows()
    {
        ...
        $db->table('tblusers_clients')->insert(array(
        ...
        $db->table('tblproductgroups')->insert(array(
        ...
        $db->table('tblproducts')->insert(array(
        ...
        $db->table('tblhosting')->insert(array(
        ...
        $db->table('tbldomains')->insert(array(
        ...
        $db->table('tblinvoices')->insert(array(
        ...
        $db->table('tblinvoiceitems')->insert(array(
        ...
        $db->table('tblticketdepartments')->insert(array(array('id' => 1, 'name' => 'Technical Support'), array('id' => 2, 'name' => 'Billing')));
        $db->table('tbltickets')->insert(array(
        ...
        $db->table('tblticketreplies')->insert(array(
        ...
        $db->table('tblticketnotes')->insert(array(array('ticketid' => 71, 'message' => 'INTERNAL NOTE: customer is on the watch list')));
    }
}
