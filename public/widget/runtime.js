  ...
  var I18n = (function () {
    var dict = {
      en: {
        ...
        resumeTitle: 'Continue your conversation',
        resumeCta: 'Continue',
        actionAi: 'Ask the AI assistant',
        actionAiSub: 'The fastest way to get an answer',
        actionHuman: 'Chat with support',
        actionHumanSub: 'Talk to a member of our team',
        actionKb: 'Search the help center',
        actionKbSub: 'Find answers to common questions',
      ...
      fa: {
        ...
        home: 'خانه',
        homeGreeting: 'سلام 👋',
        homeGreetingSub: 'چطور می‌توانیم کمکتان کنیم؟',
        resumeTitle: 'ادامه گفتگوی قبلی',
        resumeCta: 'ادامه گفتگو',
        actionAi: 'پرسش از دستیار هوش مصنوعی',
        actionAiSub: 'سریع‌ترین راه برای گرفتن پاسخ',
        actionHuman: 'گفتگو با پشتیبانی',
        actionHumanSub: 'با یکی از همکاران ما صحبت کنید',
        actionKb: 'جستجو در مرکز راهنما',
        actionKbSub: 'پاسخ پرسش‌های پرتکرار را ببینید',
        categories: 'دسته‌بندی‌ها',
        viewAll: 'مشاهده همه',
        awayLabel: 'غایب',
        offlineLabel: 'آفلاین',
        aiAnswer: 'پاسخ هوش مصنوعی',
        closeWidget: 'بستن',
        noCategories: 'هنوز دسته‌بندی‌ای وجود ندارد',
