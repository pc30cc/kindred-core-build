...
export default function AdminBrandingPage() {
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-admin-foreground">Platform Branding</h1>
      <p className="text-admin-muted-foreground text-sm">Default branding applied to all new workspaces and the public site.</p>

      <div className="grid gap-4 md:grid-cols-2">
        <Card className="bg-admin-card border-admin-border">
          <CardHeader><CardTitle className="text-admin-foreground text-sm">Default Platform Identity</CardTitle></CardHeader>
        ...
        <Card className="bg-admin-card border-admin-border">
          <CardHeader><CardTitle className="text-admin-foreground text-sm">Default SEO Settings</CardTitle></CardHeader>
          <CardContent className="text-admin-muted-foreground text-sm space-y-2">
        ...
        <Card className="bg-admin-card border-admin-border">
          <CardHeader><CardTitle className="text-admin-foreground text-sm">Default Email Branding</CardTitle></CardHeader>
          <CardContent className="text-admin-muted-foreground text-sm space-y-2">
        ...
        <Card className="bg-admin-card border-admin-border">
          <CardHeader><CardTitle className="text-admin-foreground text-sm">Default Widget Settings</CardTitle></CardHeader>
          <CardContent className="text-admin-muted-foreground text-sm space-y-2">
