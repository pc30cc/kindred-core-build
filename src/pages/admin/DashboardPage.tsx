    ...
    <div className="space-y-6">
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="text-muted-foreground text-sm space-y-2">
          <p>• Manage users and assign roles from <strong className="text-foreground">Users</strong></p>
          <p>• View all workspaces from <strong className="text-foreground">Workspaces</strong></p>
          <p>• Configure platform providers from <strong className="text-foreground">Providers</strong></p>
          <p>• Toggle features globally from <strong className="text-foreground">Feature Flags</strong></p>
          <p>• Monitor activity from <strong className="text-foreground">Audit Logs</strong></p>
        </CardContent>
      </Card>
    </div>
  );
