    ...
    <div className="space-y-6">
      ...
      <Card className="bg-slate-900 border-slate-800">
        ...
        <CardContent className="text-slate-400 text-sm space-y-2">
          <p>• Manage users and assign roles from <strong>Users</strong></p>
          <p>• View all workspaces from <strong>Workspaces</strong></p>
          <p>• Configure platform providers from <strong>Providers</strong></p>
          <p>• Toggle features globally from <strong>Feature Flags</strong></p>
          <p>• Monitor activity from <strong>Audit Logs</strong></p>
        </CardContent>
      </Card>
    </div>
  );
