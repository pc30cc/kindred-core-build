...
import { Beaker, Loader2, AlertTriangle, Bot, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Safely test your AI Agent. Nothing is sent to real conversations.</p>
      </div>
