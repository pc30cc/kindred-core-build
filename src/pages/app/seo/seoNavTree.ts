...
export const SEO_SECTIONS: SeoSection[] = [
  ...
  },
  {
    ...
    items: [
      leaf('overview', 'seo.nav.item.overview', false),
      leaf('performance', 'seo.nav.item.performance', false),
      leaf('queries', 'seo.nav.item.queries', false),
      leaf('pages', 'seo.nav.item.pages', false),
      leaf('devices', 'seo.nav.item.devices', false),
      leaf('opportunities', 'seo.nav.item.opportunities', false),
    ],
  },
  {
    key: 'web-analytics',
    ...
    items: [
      ...
      group('trafficSources', 'seo.nav.item.trafficSources', [
        leaf('channels', 'seo.nav.item.channels', false),
        leaf('sources', 'seo.nav.item.sources', false),
        leaf('campaigns', 'seo.nav.item.campaigns', false),
      ]),
      group('pages', 'seo.nav.item.pages', [
        leaf('topPages', 'seo.nav.item.topPages', false),
        leaf('entryPages', 'seo.nav.item.entryPages', false),
        leaf('exitPages', 'seo.nav.item.exitPages', false),
        leaf('clonedPages', 'seo.nav.item.clonedPages', false),
        leaf('possible404', 'seo.nav.item.possible404', false),
        leaf('siteStructure', 'seo.nav.item.siteStructure', false),
        leaf('new', 'seo.nav.item.new', false),
      ]),
      group('geography', 'seo.nav.item.geography', [
        leaf('continents', 'seo.nav.item.continents', false),
        leaf('countries', 'seo.nav.item.countries', false),
        leaf('cities', 'seo.nav.item.cities', false),
        leaf('languages', 'seo.nav.item.languages', false),
      ]),
      group('browsersSystems', 'seo.nav.item.browsersSystems', [
        leaf('browsers', 'seo.nav.item.browsers', false),
        leaf('operatingSystems', 'seo.nav.item.operatingSystems', false),
        leaf('devices', 'seo.nav.item.devices', false),
      ]),
      group('events', 'seo.nav.item.events', [
        leaf('trackedEvents', 'seo.nav.item.trackedEvents', false),
        leaf('funnels', 'seo.nav.item.funnels', false),
        leaf('eventProperties', 'seo.nav.item.eventProperties', false),
      ]),
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      leaf('overview', 'seo.nav.item.overview', false),
      leaf('aiVisibility', 'seo.nav.item.aiVisibility', false),
      leaf('searchDemand', 'seo.nav.item.searchDemand', false),
      leaf('webVisibility', 'seo.nav.item.webVisibility', false),
      leaf('competitors', 'seo.nav.item.competitors', false),
      leaf('settings', 'seo.nav.item.brandSettings', false),
    ],
  },
];
