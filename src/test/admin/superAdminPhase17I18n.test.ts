...
const files = [
  ...
  'src/components/admin/mobile/android/AndroidOverviewTab.tsx',
  'src/components/admin/mobile/android/AndroidIdentityTab.tsx',
  'src/components/admin/mobile/android/AndroidReleaseTab.tsx',
  'src/components/admin/mobile/android/AndroidInAppTab.tsx',
