...
const files = [
  'src/components/admin/observability/RealtimeControlPanel.tsx',
  'src/components/admin/observability/FailoverStatePanel.tsx',
  'src/components/admin/observability/ReliabilityPanel.tsx',
];

const technicalCopy = new Set(['realtime_provider_lock', 'ms', 'SLO']);
...
describe('Super Admin phase 5 localization', () => {
