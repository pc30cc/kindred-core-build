-- 20260819140000 — Auth migration follow-up: `profiles.phone`.
--
...
-- now the first-party identity root (20260819130000), the field needs a
-- home there instead. Purely additive: existing profiles get
-- `phone = NULL`, matching "no phone set" — no data loss, no behavior
-- change for anyone who never set one.
