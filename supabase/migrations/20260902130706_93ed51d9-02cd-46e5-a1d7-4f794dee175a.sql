-- =========================================================================
-- WORKSPACE INVITATIONS v5.1 — hosted mirror of self-host migrations
-- 087 (A-residual canonical account_exists + B atomic idempotency) and
-- 088 (safe-result projection fix). Forward-only, no earlier migration edited.
-- =========================================================================
