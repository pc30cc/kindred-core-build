-- ============================================================================
-- BILLING ENGINE V2 — PHASE D0: entitlement cycles
-- ============================================================================
...
BEGIN
  ...
  LOOP
    ...
    v_step  := v_step + 1;
    v_idx   := v_idx + 1;
    EXIT WHEN v_start >= v_period.period_end OR v_idx > 24;
  END LOOP;
...
-- ─── 5. Period activation delegates the allowance to the cycle ─────────────
