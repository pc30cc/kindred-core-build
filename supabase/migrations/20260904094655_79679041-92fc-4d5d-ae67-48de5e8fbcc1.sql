-- BILLING ENGINE V2 — PHASE E: dunning, reminders, grace, fallback
...
-- ─── 3. Retention SIGNAL (no purge here, ever) ─────────────────────────────
...
ALTER TABLE public.billing_v2_jobs ADD CONSTRAINT billing_v2_jobs_type_check
  CHECK (job_type IN (
    ...
    'entitlement_cycle', 'dunning_due', 'grace_expiry'
  ));
