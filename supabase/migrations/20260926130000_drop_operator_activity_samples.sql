-- ============================================================
-- DROP operator_activity_samples
--
-- Self-host mirror: database/migrations/223_drop_operator_activity_samples.sql
...
-- partitioned here since 20260913221951, with the pre-partitioning copy
-- operator_activity_samples_legacy — and a retention policy for it. Nothing
-- has written it since production dropped it, and its last reader, the
-- coarse fallback in server/services/widget/operatorActivity.ts (which
-- answered 404 twice after every backend start), is removed in the same
-- change.
--
