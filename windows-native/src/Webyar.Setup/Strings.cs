...
namespace Webyar.Setup
{
    ...
    public sealed class Strings
    {
        ...
        private static readonly Dictionary<string, string> Fa = new Dictionary<string, string>
        {
            ...
            ["welcomeBody"] = "چند ثانیه بیشتر طول نمی‌کشد. وب‌یار مثل بقیه برنامه‌ها در Program Files نصب می‌شود، در منوی استارت می‌آید و از تنظیمات ویندوز قابل حذف است.",
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            ["welcomeBody"] = "It only takes a few seconds. Webyar installs in Program Files like any other program, appears in the Start menu and can be removed from Windows Settings.",
        ...
        private static readonly Dictionary<string, string> Tr = new Dictionary<string, string>
        {
            ...
            ["welcomeBody"] = "Yalnızca birkaç saniye sürer. Webyar diğer programlar gibi Program Files'a yüklenir, Başlat menüsünde görünür ve Windows Ayarlar'dan kaldırılabilir.",
